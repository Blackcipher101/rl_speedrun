...
Q-Learning learns the optimal action-value function Q* directly,
regardless of the policy being followed for exploration.
...
Key Property: Off-policy
    ...
    - Target policy: Greedy (the max operation)
...
if __name__ == "__main__":
    ...
    # Train
    print("\nTraining Q-Learning...")
    Q, returns, lengths = q_learning(env, **config)
    ...
    # Learning curve
    axes[0].plot(smoothed_returns, color='blue', linewidth=1)
    axes[0].set_xlabel('Episode')
    axes[0].set_ylabel('Return (smoothed)')
    axes[0].set_title('Q-Learning on FrozenLake-v1')
    ...
    print("\nSaved learning curve to: q_learning_frozenlake.png")
